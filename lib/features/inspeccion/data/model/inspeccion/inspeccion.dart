...
List<Inspeccion> inspeccionsFromJson(List<dynamic> data) =>
    List<Inspeccion>.from(data.map((x) => Inspeccion.fromJson(x)));

Inspeccion inspeccionFromJson(String str) =>
    Inspeccion.fromJson(json.decode(str));

String inspeccionToJson(Inspeccion data) => json.encode(data.toJson());
