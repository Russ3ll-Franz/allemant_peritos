...
class _$RecordsFindTearOff {
  ...
  _RecordsFind call(
      ...
      @JsonKey(name: 'coor_estado_id')
          required String coorEstadoId,
      @JsonKey(name: 'coor_estado_nombre')
          required String coorEstadoNombre,
...
class _$_RecordsFind implements _RecordsFind {
  _$_RecordsFind(
      ...
      @JsonKey(name: 'coor_estado_id')
          required this.coorEstadoId,
      @JsonKey(name: 'coor_estado_nombre')
          required this.coorEstadoNombre,
      @JsonKey(name: 'coordinador_id')
      ...
      @JsonKey(name: 'inspeccion_observacion')
          required this.inspeccionObservacion,
      @JsonKey(name: 'estado_id')
