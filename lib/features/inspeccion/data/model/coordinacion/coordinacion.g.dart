    ...
    $checkedCreate(
      ...
      ($checkedConvert) {
        final val = _$_Coordinacion(
          ...
          tipoVisitaId: $checkedConvert('tipo_visita_id', (v) => v as String?),
          tipoVisitaNombre:
              $checkedConvert('tipo_visita_nombre', (v) => v as String?),
        );
        return val;
      },
      fieldKeyMap: const {
        ...
        'tipoVisitaId': 'tipo_visita_id',
        'tipoVisitaNombre': 'tipo_visita_nombre'
      },
    );
...
Map<String, dynamic> _$$_CoordinacionToJson(_$_Coordinacion instance) =>
    <String, dynamic>{
      ...
      'tipo_visita_id': instance.tipoVisitaId,
      'tipo_visita_nombre': instance.tipoVisitaNombre,
    };
