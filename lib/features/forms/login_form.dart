    ...
    return BlocBuilder<LoginBloc, LoginState>(
      ...
      builder: (context, state) {
        return TextFormField(
          ...
          onChanged: (username) => context.read<LoginBloc>().add(LoginEvent.loginUsernameChanged(username)),
    ...
    return BlocBuilder<LoginBloc, LoginState>(
      ...
      builder: (context, state) {
        return TextFormField(
          ...
          onChanged: (password) => context.read<LoginBloc>().add(LoginEvent.loginPasswordChanged(password)),
          decoration: InputDecoration(
            labelText: 'password',
