...
class _$LoginResponseTearOff {
  ...
  _LoginResponse call({bool? status, String? message, User? user}) {
...
class _$_LoginResponse implements _LoginResponse {
  _$_LoginResponse({this.status, this.message, this.user});
...
abstract class _LoginResponse implements LoginResponse {
  factory _LoginResponse({bool? status, String? message, User? user}) =
      _$_LoginResponse;
